...
def run_yoga_detection(model_path=None, scaler_path=None, camera_id=0, demo_mode=False):
        ...
        while cap.isOpened():
            ...
            if len(landmarks) > 0:
                ...
                if features is not None:
                    if demo_mode or manual_pose_selection:
                        # Use manually or randomly selected pose
                        pose_name = YOGA_POSES[current_pose_idx]
            ...
            # Add instructions
            cv2.putText(output_image, "Press 'q' to quit", (10, output_image.shape[0] - 40), 
                        cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
            cv2.putText(output_image, "Press 'n' to switch pose mode", (10, output_image.shape[0] - 10), 
                        cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
            ...
            if key == ord('q'):
                ...
                # Toggle manual pose selection
                manual_pose_selection = not manual_pose_selection
                
                if manual_pose_selection:
                    # Increment pose index with wraparound
                    current_pose_idx = (current_pose_idx + 1) % len(YOGA_POSES)
...
if __name__ == "__main__":
    ...
    run_yoga_detection(args.model, args.scaler, args.camera, args.demo)